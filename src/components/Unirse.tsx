...
export function Unirse() {
  return (
    <section id="programas" className="pt-26 pb-12 bg-secondary">
      <div className="container max-w-7xl mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-serif text-secondary-foreground mb-6">Unirse a programas</h2>

    ...
    <section id="metodologia" className="pt-26 pb-12 bg-card">
      <div className="container max-w-7xl mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-serif text-primary mb-6">Metodología</h2>
            <p className="text-lg text-muted-foreground">La Introducción va antes de esto? /n Agregar contenido de intro y poner botón a página más extensa</p>
          </motion.div>
        </div>
      </div>
    </section>

...
export function NuestrasInv() {
  return (
    <section id="inv-propias" className="pt-26 pb-12 bg-muted/30">
      <div className="container max-w-7xl mx-auto px-6 md:px-12">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-serif text-secondary mb-6">Nuestras investigaciones</h2>
